import tkinter 
#tk-inter is used for the graphical user interface(library)
...
def set_tile(row, column):
    ...
    board[row][column]["text"] = currentPlayer #mark the board


    if currentPlayer == playerO: #switch player
...
label = tkinter.Label(frame, text=currentPlayer+"'s turn", font= ("consolas",20), background=color_gray,
                      foreground="white")
